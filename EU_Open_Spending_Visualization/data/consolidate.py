...
# print "land", conversion[0].keys()[0]
# print "2007", data2007[conversion[0].keys()[0]]
# print "2008", data2008[conversion[0].keys()[0]]
# print "2009", data2009[conversion[0].keys()[0]]
# print "2010", data2010[conversion[0].keys()[0]]
# print "2011", data2011[conversion[0].keys()[0]]
# print "2012", data2012[conversion[0].keys()[0]]
# print "2013", data2013[conversion[0].keys()[0]]
...
for item in conversion:
	try:
		output.append({conversion[i].values()[0] : [data2007[conversion[i].keys()[0]], data2008[conversion[i].keys()[0]], data2009[conversion[i].keys()[0]], data2010[conversion[i].keys()[0]], data2011[conversion[i].keys()[0]], data2012[conversion[i].keys()[0]], data2013[conversion[i].keys()[0]]]})
	except:
		pass
	i += 1
